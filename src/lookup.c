...
//
// lookup.c: Resolve AstPath to a NodeId
...
//        return NULL;
//
//    pawIr_set_type(Q->C, seg->id, method);
...
//    pawIr_set_type(Q->C, seg->id, inst);
...
//        pawIr_set_type(Q->C, next->id, method);
...
//                type = pawIr_get_type(Q->C, symbol.res.id);
//            } else {
...
//
//            Q->index = 1;
//            pawIr_set_type(Q->C, seg->id, type);
//            seg->res = symbol.res;
...
//        return pawIr_get_type(Q->C, seg->res.id);
//
