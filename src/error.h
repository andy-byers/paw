...
enum ErrorKind {
    ...
    E_INVALID_ESCAPE,
    E_INVALID_HEX_ESCAPE,
    E_HEX_ESCAPE_TOO_SHORT,
    E_UNICODE_ESCAPE_TOO_LONG,
    E_UNTERMINATED_UNICODE_ESCAPE,
...
_Noreturn void pawErr_colons_after_underscore(struct Compiler *C, Str const *modname, struct SourceLoc loc);
...
// import errors
_Noreturn void pawErr_module_not_found(struct Compiler *C, Str const *modname, struct SourceLoc loc, char const *what);
...
_Noreturn void pawErr_cannot_constant_evaluate(struct Compiler *C, Str const *modname, struct SourceLoc loc, char const *type);
...
_Noreturn void pawErr_not_a_method(struct Compiler *C, Str const *modname, struct SourceLoc loc, char const *type);
