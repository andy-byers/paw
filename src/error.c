...
{
    throw(C, E_UNSUPPORTED, modname, loc,
            format(C, "\"%s\" is not supported", feature),
            NULL);
}

_Noreturn void pawErr_empty_char(struct Compiler *C, Str const *modname, struct SourceLoc loc)
{
    throw(C, E_EMPTY_CHAR, modname, loc,
            format(C, "character literal is empty"),
            NULL);
}

_Noreturn void pawErr_char_too_long(struct Compiler *C, Str const *modname, struct SourceLoc loc)
{
    throw(C, E_CHAR_TOO_LONG, modname, loc,
            format(C, "character literal is too long"),
            NULL);
}

_Noreturn void pawErr_unterminated_char(struct Compiler *C, Str const *modname, struct SourceLoc loc)
{
    throw(C, E_UNTERMINATED_CHAR, modname, loc,
            format(C, "unterminated character literal"),
            NULL);
}

_Noreturn void pawErr_unterminated_string(struct Compiler *C, Str const *modname, struct SourceLoc loc)
{
    throw(C, E_UNTERMINATED_STRING, modname, loc,
            format(C, "unterminated string literal"),
            NULL);
}

_Noreturn void pawErr_invalid_escape(struct Compiler *C, Str const *modname, struct SourceLoc loc, char c)
{
...
_Noreturn void pawErr_invalid_hex_escape(struct Compiler *C, Str const *modname, struct SourceLoc loc)
{
    throw(C, E_INVALID_HEX_ESCAPE, modname, loc,
            format(C, "invalid hex escape"),
            NULL);
}

_Noreturn void pawErr_hex_escape_too_short(struct Compiler *C, Str const *modname, struct SourceLoc loc)
{
    throw(C, E_HEX_ESCAPE_TOO_SHORT, modname, loc,
            format(C, "hex escape too short"),
            NULL);
}


_Noreturn void pawErr_unterminated_unicode_escape(struct Compiler *C, Str const *modname, struct SourceLoc loc)
{
    throw(C, E_UNTERMINATED_UNICODE_ESCAPE, modname, loc,
            format(C, "unterminated unicode escape"),
            NULL);
}

_Noreturn void pawErr_unicode_escape_too_long(struct Compiler *C, Str const *modname, struct SourceLoc loc)
{
...
_Noreturn void pawErr_invalid_unicode_escape(struct Compiler *C, Str const *modname, struct SourceLoc loc, char const *codepoint)
{
...
_Noreturn void pawErr_invalid_literal_negation(struct Compiler *C, Str const *modname, struct SourceLoc loc)
{
...
_Noreturn void pawErr_invalid_selector(struct Compiler *C, Str const *modname, struct SourceLoc loc)
{
...
_Noreturn void pawErr_expected_basic_type(struct Compiler *C, Str const *modname, struct SourceLoc loc, char const *what)
{
...
_Noreturn void pawErr_expected_expression(struct Compiler *C, Str const *modname, struct SourceLoc loc)
{
...
_Noreturn void pawErr_empty_enumeration(struct Compiler *C, Str const *modname, struct SourceLoc loc)
{
...
_Noreturn void pawErr_jump_outside_loop(struct Compiler *C, Str const *modname, struct SourceLoc loc, char const *kind)
{
...
_Noreturn void pawErr_expected_colon_after_map_key(struct Compiler *C, Str const *modname, struct SourceLoc loc)
{
...
_Noreturn void pawErr_colon_after_list_element(struct Compiler *C, Str const *modname, struct SourceLoc loc)
{
...
_Noreturn void pawErr_expected_self_parameter(struct Compiler *C, Str const *modname, struct SourceLoc loc, char const *name)
{
...
_Noreturn void pawErr_unexpected_underscore(struct Compiler *C, Str const *modname, struct SourceLoc loc)
{
...
_Noreturn void pawErr_expected_comma_separator(struct Compiler *C, Str const *modname, struct SourceLoc loc, char const *what)
{
...
_Noreturn void pawErr_cyclic_type(struct Compiler *C, Str const *modname, struct SourceLoc loc)
{
...
_Noreturn void pawErr_missing_extern_value(struct Compiler *C, Str const *modname, struct SourceLoc loc, char const *name)
{
...
_Noreturn void pawErr_expected_value(struct Compiler *C, Str const *modname, struct SourceLoc loc, char const *type)
{
...
_Noreturn void pawErr_invalid_chain_operand(struct Compiler *C, Str const *modname, struct SourceLoc loc, char const *type)
{
...
_Noreturn void pawErr_invalid_unary_operand(struct Compiler *C, Str const *modname, struct SourceLoc loc, char const *type, char const *op)
{
...
_Noreturn void pawErr_invalid_binary_operand(struct Compiler *C, Str const *modname, struct SourceLoc loc, char const *type, char const *op)
{
...
_Noreturn void pawErr_cannot_constant_evaluate(struct Compiler *C, Str const *modname, struct SourceLoc loc, char const *what)
{
...
_Noreturn void pawErr_nonprimitive_constant(struct Compiler *C, Str const *modname, struct SourceLoc loc, char const *type)
{
...
_Noreturn void pawErr_expected_element_selector(struct Compiler *C, Str const *modname, struct SourceLoc loc)
{
...
_Noreturn void pawErr_element_selector_out_of_range(struct Compiler *C, Str const *modname, struct SourceLoc loc, int elem, int count)
{
...
_Noreturn void pawErr_expected_adt(struct Compiler *C, Str const *modname, struct SourceLoc loc, char const *type)
{
...
_Noreturn void pawErr_expected_field_selector(struct Compiler *C, Str const *modname, struct SourceLoc loc)
{
...
_Noreturn void pawErr_unknown_method(struct Compiler *C, Str const *modname, struct SourceLoc loc, char const *method, char const *type)
{
...
_Noreturn void pawErr_unknown_associated_item(struct Compiler *C, Str const *modname, struct SourceLoc loc, char const *method, char const *type)
{
...
_Noreturn void pawErr_not_a_method(struct Compiler *C, Str const *modname, struct SourceLoc loc, char const *name)
{
...
_Noreturn void pawErr_not_callable(struct Compiler *C, Str const *modname, struct SourceLoc loc, char const *type)
{
...
_Noreturn void pawErr_incorrect_arity(struct Compiler *C, Str const *modname, struct SourceLoc loc, int want, int have)
{
...
_Noreturn void pawErr_duplicate_field(struct Compiler *C, Str const *modname, struct SourceLoc loc, char const *name, char const *type)
{
...
_Noreturn void pawErr_duplicate_binding(struct Compiler *C, Str const *modname, struct SourceLoc loc, char const *name)
{
...
_Noreturn void pawErr_expected_struct(struct Compiler *C, Str const *modname, struct SourceLoc loc, char const *type)
{
...
_Noreturn void pawErr_unit_struct_with_braces(struct Compiler *C, Str const *modname, struct SourceLoc loc, char const *type)
{
...
_Noreturn void pawErr_unit_variant_with_parenthesis(struct Compiler *C, Str const *modname, struct SourceLoc loc, char const *type)
{
...
_Noreturn void pawErr_global_constant_cycle(struct Compiler *C, Str const *modname, struct SourceLoc loc, char const *name)
{
...
_Noreturn void pawErr_uninitialized_destructuring(struct Compiler *C, Str const *modname, struct SourceLoc loc)
{
...
_Noreturn void pawErr_modified_constant(struct Compiler *C, Str const *modname, struct SourceLoc loc, char const *name)
{
...
_Noreturn void pawErr_too_many_upvalues(struct Compiler *C, Str const *modname, struct SourceLoc loc, int limit)
{
...
_Noreturn void pawErr_initialized_extern_constant(struct Compiler *C, Str const *modname, struct SourceLoc loc, char const *name)
{
...
_Noreturn void pawErr_uninitialized_constant(struct Compiler *C, Str const *modname, struct SourceLoc loc, char const *name)
{
...
_Noreturn void pawErr_infinite_size_object(struct Compiler *C, Str const *modname, struct SourceLoc loc, char const *name)
{
...
_Noreturn void pawErr_object_too_large(struct Compiler *C, Str const *modname, struct SourceLoc loc, char const *name)
{
...
_Noreturn void pawErr_nonexhaustive_pattern_match(struct Compiler *C, Str const *modname, struct SourceLoc loc)
{
...
_Noreturn void pawErr_use_before_initialization(struct Compiler *C, Str const *modname, struct SourceLoc loc, char const *name)
{
...
_Noreturn void pawErr_constant_divide_by_zero(struct Compiler *C, Str const *modname, struct SourceLoc loc)
{
...
_Noreturn void pawErr_constant_negative_shift_count(struct Compiler *C, Str const *modname, struct SourceLoc loc)
{
...
_Noreturn void pawErr_too_many_variables(struct Compiler *C, Str const *modname, struct SourceLoc loc, int limit)
{
